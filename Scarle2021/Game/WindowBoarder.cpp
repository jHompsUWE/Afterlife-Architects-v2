...
void WindowBoarder::set_postion(Vector2& _new_pos)
{
    UIWindow::setPostion(_new_pos);
}

void WindowBoarder::setScale(Vector2& _newScale)
{
    UIWindow::setScale(_newScale);
}

Vector2& WindowBoarder::getPosition()
{
    return UIWindow::getPosition();
}

Vector2& WindowBoarder::getButtonRes()
{
    return UIWindow::getButtonRes();
}

void WindowBoarder::reSize(Vector2 game_res)
{
